...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
			print "DDOS LANCER BY LORIXO 6666666666666666666666666666666666666666 error"
			code=500
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				...
				previous=request_counter
		if flag==2:
			print "\n-- DDOS LANCER BY LORIXO 6666666666666666666666666666666666666666 error"
